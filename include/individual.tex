...
\node at ($(current page.center)+(0,-1.25)$) {{\fontsize{36}{72} \selectfont Técnicas de Modelamiento}};
\node at ($(current page.center)+(0,-3)$) {{\fontsize{24}{72} \selectfont\textbf{Informe:}}};
\node at ($(current page.center)+(0,-3.75)$) {{\fontsize{20}{72} \selectfont Resolución de diferentes EDOs}};

\node[text width=15cm,align=center] at ($(current page.center)+(0,-5.5)$) {{\fontsize{16}{19.2} \selectfont \textcolor{black}{ \textbf{Profesor:}\\ \vspace{0.5em}Vidal Vega, Yefri Ander }}};

\node[text width=15cm,align=center] at ($(current page.center)+(0,-8)$) {{\fontsize{16}{19.2} \selectfont \textcolor{black}{ \textbf{Estudiante:}\\Espinoza Huaman, Diego Alexhander\\ \vspace{1em}\textbf{Código:} 22140106}}};
